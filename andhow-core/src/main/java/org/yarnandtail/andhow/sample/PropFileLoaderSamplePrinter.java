...
public class PropFileLoaderSamplePrinter extends BaseSamplePrinter implements SamplePrinter {
	...
	@Override
	public TextBlock getSampleStartComment(StaticPropertyConfiguration definition) {
	...
	@Override
	public String getInAliaseString(StaticPropertyConfiguration definition, EffectiveName name) {
		return name.getActualName();
	}
	
	@Override
	public TextBlock getActualProperty(StaticPropertyConfiguration definition, 
