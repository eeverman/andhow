...
public abstract class BaseSamplePrinter implements SamplePrinter {
	 ...
	 * @return
	 */
	public abstract TextBlock getSampleStartComment(PropertyConfigurationInternal definition);

	public abstract String getInAliaseString(PropertyConfigurationInternal definition, EffectiveName name);

	public abstract TextBlock getActualProperty(PropertyConfigurationInternal definition,
	...
	@Override
	public void printPropertyGroupStart(PropertyConfigurationInternal definition,
	...
	@Override
	public void printProperty(PropertyConfigurationInternal definition, PrintStream out,
	...
	@Override
	public void printPropertyGroupEnd(PropertyConfigurationInternal definition,
                                      PrintStream out, GroupProxy group) {
	}
