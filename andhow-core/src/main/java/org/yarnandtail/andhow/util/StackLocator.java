...
public class StackLocator {
	 ...
	 * 
	 * @param fqcn Fully qualified class name of the class that was called.
	 * @param pkg Package of the class you are interested in finding who called the fqcn class.
	 * @return The Class that made the call, or null if it cannot be found.
	 */
	 ...
	 * 
	 * This could return the anchor class if the caller was in the same class.
	 * 
	 * @param anchor
	 * @return 
	 */
