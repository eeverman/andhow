...
public class AndHowTest extends AndHowTestBase {
	...
	public void findConfigLocatorShouldBeUsedIfNonNullAndOnlyOnFirstFindConfigCall() {
		...
		NoDependencyAndHowTestUtil.setAndHowConfigLocator((c) -> {
	...
	public void findConfigShouldReturnNewConfigIfReentrant() {
		...
		NoDependencyAndHowTestUtil.setAndHowConfigLocator(
				c -> AndHow.findConfig()
		);
	...
	public void initializedMethodShouldAgreeWithSmashedCoreForTestingInitializationProcess() {
		...
		AndHowCore orgCore = NoDependencyAndHowTestUtil.setAndHowCore(null);

		assertNotNull(NoDependencyAndHowTestUtil.getAndHow(), "The instance should still exist");
		...
		AndHowCore afterCore = (AndHowCore)NoDependencyAndHowTestUtil.getAndHowCore();
