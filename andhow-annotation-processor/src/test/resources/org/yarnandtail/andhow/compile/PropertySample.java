...
/**
 * This is a copy of the PropertySample.java source file in the test source
 * directory.  This copy is used for unit testing of the AndHowCompileProcessor,
 * which needs a source file to work from.
 * 
 * @author ericeverman
 */
