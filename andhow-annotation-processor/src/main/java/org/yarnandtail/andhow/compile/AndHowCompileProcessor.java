		...
		for (Element e : roundEnv.getRootElements()) {
			...
			for (CompileUnit.Property p : ret.getProperties()) {
				...
				if (p.getParents().length > 0) {
					System.out.println("Found Property '" + p.getName() + "'in : " + te.getQualifiedName() + " in: ");
					for (TypeElement tee : p.getParents()) {
						System.out.println("      - " + tee.getSimpleName());
					}
				} else {
					System.out.println("Found Property '" + p.getName() + "'in : " + te.getQualifiedName());
				}
