...
public @interface ConfigFromFileBeforeEachTest {
	 ...
	 * to configure AndHow Property values before the run of each test in this class.
	 * <p>
	 ...
	 * {@code @ConfigFromFileBeforeEachTest("myFile.props")}<br>
	 * Otherwise the full syntax must be used:<br>
	 * {@code @ConfigFromFileBeforeEachTest(value = "myFile.props"), includeClasses = {Conf1.class, Conf2.class}}<br>
	 * <p>
