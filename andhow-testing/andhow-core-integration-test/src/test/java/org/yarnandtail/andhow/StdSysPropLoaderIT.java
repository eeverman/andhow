...
/**
 * Tests the StdSysPropLoader as the only loader with a completely configured
 * AndHowCore.
 * <p>
...
public class StdSysPropLoaderIT {
	...
	public void testTest() {
		...
		assertTrue(config.buildLoaders().get(0) instanceof StdSysPropLoader);
	...
	public void anUnrecognizedPropertyShouldNotCauseAProblem() throws Exception {
		...
		coord.runForValues(true, true, false);
	}
	...
	public void assertUnsetNonFlagsCauseProblems() throws Exception {
		...
		coord.runForProblems(false, true, false);
	}
	...
	public void assertValues1() throws Exception {
		...
		TestCoordinator coord = new TestCoordinator(config, propValueLoader, strExpect, flagExpect, intExpect);
		coord.runForValues(false, true, false);
	}
